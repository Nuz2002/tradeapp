...
const SidebarLayout = () => {
  ...
  const webhookEvents = [
    {
      id: 1,
      event: "Order Placed",
      time: "2024-06-01 12:34",
      status: "Success",
    },
    {
      id: 2,
      event: "Order Cancelled",
      time: "2024-06-01 13:10",
      status: "Failed",
    },
    {
      id: 3,
      event: "Balance Updated",
      time: "2024-06-01 14:22",
      status: "Success",
    },
    {
      id: 4,
      event: "Order Filled",
      time: "2024-06-01 15:05",
      status: "Pending",
    },
  ];
  ...
  return (
    <div className="flex">
      ...
      >
        <div
          className={`bg-white border-r border-gray-100 shadow-md h-full flex flex-col justify-between transition-all duration-300 ${
            collapsed ? "w-16" : "w-56"
          }`}
        >
          <div>
            ...
            <div className="flex-1 flex flex-col gap-2 mt-4">
              {menu.map((item) => (
                ...
                >
                  ...
                  {collapsed && (
                    <span className="absolute left-full ml-2 top-1/2 -translate-y-1/2 bg-gray-900 text-white text-xs rounded px-2 py-1 opacity-0 group-hover:opacity-100 pointer-events-none transition-opacity">
                      {item.label}
                    </span>
                  )}
                </button>
                        ...
                        <span
                          ...
                          ${
                            event.status === "Success"
                              ...
                              : event.status === "Failed"
                              ? "bg-gray-100 text-red-500 border-red-200"
